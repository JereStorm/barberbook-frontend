...
import { Building2, Edit, MapPin, Phone, Trash2, Users } from 'lucide-react'
...
export const SalonsCard = (props: Props) => {
    const { salon, openEditModal, handleDeleteSalon } = props;
    const bgClass = getBackground(salon.id);

    return (
        <div key={salon.id} className={`${bgClass} rounded-lg shadow hover:shadow-lg transition-shadow`}>
            <div className="p-6">
