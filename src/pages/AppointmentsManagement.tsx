...
const AppointmentsManagement: React.FC = () => {
  ...
  const filteredAppointments = useAppointmentSearch(appointments, searchTerm, [
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white rounded-lg shadow p-6 py-8">
        ...
        {!isStylist && <CreateButton openCreateModal={openCreateModal} />}
      </div>
      ...
      {viewMode === "cards" ? (
        <AppointmentCards
          ...
          onCanceled={handleCanceledAppointment}
